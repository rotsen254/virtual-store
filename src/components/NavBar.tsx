  ...
  return (
    <>
      <header>
        ...
        <nav id="navbar">
          <NavButton titulo="Ofertas" link="/"/>
          <NavButton titulo="Como comprar" link="/"/>
          <NavButton titulo="Costos y Tarifas" link="/"/>
          <NavButton titulo="Mis pedidos" link="/"/>
          <NavButton titulo="Garantía" link="/"/>
